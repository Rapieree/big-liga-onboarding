...
/* harmony import */ var _modules_promo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/promo */ "./js/modules/promo.js");
...
Object(_modules_promo__WEBPACK_IMPORTED_MODULE_4__["initPromo"])();
...
/* harmony import */ var _utils_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/constants */ "./js/utils/constants.js");
...
var loaderPrompt = loader.querySelector('.loader__prompt');
var wrapper = document.querySelector('.wrapper');
var loaderShowingClass = 'loader--show';
var loaderFadeAnimationClass = 'loader--fade';
var loaderPromptShowClass = 'loader__prompt--show';
var wrapperShowingClass = 'wrapper--show';
...
var onLoaderClick = function onLoaderClick() {
  loaderShow(false);
};

var onLoaderLoad = function onLoaderLoad() {
  loaderPrompt.classList.add(loaderPromptShowClass);

  if (document.documentElement.clientWidth < _utils_constants__WEBPACK_IMPORTED_MODULE_0__["Viewports"].LARGE) {
...
var loaderShow = function loaderShow(flag) {
  if (flag) {
...
var promoDescriptionBlock = promo.querySelector('.promo__description-block');
var promoDescriptionBlockShowClass = 'promo__description-block--show';

var onPromoClick = function onPromoClick() {
  promoDescriptionBlock.classList.toggle(promoDescriptionBlockShowClass);
};

var initPromo = function initPromo() {
  if (promo && document.documentElement.clientWidth <= _utils_constants__WEBPACK_IMPORTED_MODULE_0__["Viewports"].LARGE) {
